...
class exportExcelCashOut implements FromArray, WithHeadings, WithEvents
{
    protected $cashOut;
    
    public function __construct(array $cashOut)
    {
    ...
    public function registerEvents(): array
    {
        ...
        return [
            ...
            BeforeSheet::class => function(BeforeSheet $event) {
                $event->sheet->setCellValue('A1', 'Laporan Kas Keluar');
